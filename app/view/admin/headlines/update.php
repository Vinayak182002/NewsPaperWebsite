...
<form method="POST" action="update_upload.php" enctype="multipart/form-data">
    <input type="hidden" value="<?php echo $id; ?>" name="headline_id">
    <h1>Headlines Update Operation</h1>
    <h3>Title</h3>
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="form-group text-dark h6">
                Select Image:
                <input type="file" name="headingimage" value="<?php echo $imgpath; ?>" id="headingimage" class="form-control">
