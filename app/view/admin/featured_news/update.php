...
if ($_GET['id']) {
    ...
    $query = "SELECT * FROM featured_news WHERE id='$id'";
...
<form method="POST" action="update_upload.php" enctype="multipart/form-data">
    <input type="hidden" value="<?php echo $id; ?>" name="featured_news_id">
    <h1>Featured News Update Operation</h1>
    <h3>Title</h3>
    ...
    <button type="submit" name="done2">Submit</button>
