...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between" style="margin-left: 120px;">
        <h1 class="h1 mb-0 text-gray-800">Main News</h1>
        <div class="text-right">
            <a href="admin/main_news/insert.php" style="margin-right: 150px;"><button class="btn btn-success" type="submit" name="insert">
                    <h5>Insert</h5>
                </button></a>
        </div>
    </div>
                ...
                ?>
                    <tr class="text-center">
                        ...
                        <td> <button class="btn-danger btn">
                                <a href="admin/main_news/delete.php?id=<?php echo $res['id']; ?>" class="text-white">
                                    Delete </a></button></td>

                        <td> <button class="btn-primary btn">
                                <a href="admin/main_news/update.php?id=<?php echo $res['id']; ?>" name="update" class="update_id text-white"> Edit </a> </button> </td>
                    </tr>
                <?php
                }
                ?>
